...
import SEGNATURE from '../../assets/images/signature.png'
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    <motion.div
                        ...
                        className={`p-8 rounded-2xl border ${
                            isDarkMode 
                                ? "bg-gray-800/50 border-gray-700 backdrop-blue-sm" 
                                : "bg-gray-50/80 border-gray-200 backdrop-blue-sm"
                        }`}
                    >
                    ...
                    <motion.div variants={itemVariants} className="text-center py-8">
                        ...
                        <div className="flex justify-center">
                            <img src={SEGNATURE} alt="ibrahem.a.mohammad" className="w-28"/>
                        </div>
                ...
                <motion.div
                    ref={timelineRef}
                    initial="hidden"
                    animate={timelineInView ? "visible" : "hideen"}
                    ...
                    <div className="space-y-8">
                        {JOURNEY_STEPS.map((step, index) => (
                            ...
                            >
                                {/* timeline Dot */}
                                <div
                                    className={`relative z-10 flex-shrink-0 w-16 h-16 rounded-full ${step.color}
                                ...
                                <div
                                    className={`flex-grow p-6 rounded-xl border transition-all duration-300 ${
                                        isDarkMode 
                                            ...
                                            : "bg-white/80 border-gray-200 group-hover:border-gray-300 group-hover:bg-gray-white"
                                    } backdrop-blur-sm`}
                                >
            ...
            >
                ...
                >
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="bg-blue-500 hover:ng-blue-600 text-white px-8 py-3 rounded-full text-sm uppercaes tracking-wider font-medium transition-all duration-300"
                    >
                        Let's Work Together
                    </motion.button>
                </motion.div>
