                    ...
                    <div className="flex items-center mb-6">
                        <div
                            className={`p-3 rounded-xl ${
                                isDarkMode ? "bg-gary-800" : "bg-gray-100"
                            } mr-4`}
                        >   
                        ...
                        {category.skills.map((skill, skillIndex) => (
                            <div key={skill.name} className="group">
                                ...
                                >
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-white/20 rounded-full opacity-0 group-hover:opacity-100 transition-opcaity duration-300"/>
                                    </motion.div>
                                </div>
                            </div>
                        ))}
                    ...
                    <motion.span
                        ...
                        className={`px-4 py-2 text-sm rounded-full border transition-all duration-300 ${
                            isDarkMode 
                                ...
                                : "bg-white border-gray-300 text-gray-700 hover:border-gary-400"
                        }`}
                    >
                        {tech}
                    </motion.span>
